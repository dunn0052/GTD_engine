...
#l.addRunningCommand(lambda:s.levelBuffer.newLevel.TRIGGER_LAYER.get_sprite(0).setInteraction(lambda: s.nextLevel("levels//ashHouseFirstFloor.pkl", 3, 8)))
#l.addLevelTransition("levels//ashHouseFirstFloor.pkl", 0, 3, 8)
l.setTrigger(0, lambda: s.nextLevel("levels//ashHouseFirstFloor.pkl", 3, 8))
l.saveLevel()
