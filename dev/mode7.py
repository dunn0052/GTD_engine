...
# image clip from original for movement
# set starting point at (x, y)
# doX() commands
# integrate it as sprite image
# move image on screen for full horizon effect
